...
on your computer. If you're using Windows, you'll need to use Git Bash, installed in the setup instructions.

We will spend most of our time learning about the basics of the shell
by manipulating some experimental data.

After launching the shell, you may see some information like this

~~~
Last login: Sun Nov 26 20:53:14 on ttys004
You have mail.
~~~
{: .output}

We're not going to use most of this information for
